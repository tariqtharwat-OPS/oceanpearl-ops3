...
async function runSimulation() {
    ...
    // Outputs: 45kg Fillet, 5kg Roe, 50kg Waste (100kg out)
    // Yield Ratio should be 1.0 (total weight) or 0.45 (fillet yield) 
    // Usually yield ratio in processing is output weight / input weight.
