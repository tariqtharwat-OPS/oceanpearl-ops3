...
return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
            ...
            <p style={{ color: '#64748b' }}>Check the origin and history of your seafood batch</p>
        </div>
            ...
            <div style={{ animation: 'fadeIn 0.5s ease-out' }}>
                <div style={{ borderBottom: '2px solid #f1f5f9', paddingBottom: '1.5rem', marginBottom: '1.5rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                        <DataField label="SKU" value={data.batch.skuId} />
                        <DataField label="Status" value={data.batch.status} highlight />
                        <DataField label="Location" value={data.batch.locationId} />
                        <DataField label="Unit" value={data.batch.unitId} />
                    </div>
                </div>
