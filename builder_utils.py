        ...
        <div class="bg-white p-8 rounded shadow border-t-8 border-emerald-600 max-w-5xl mb-8">
            <div class="flex justify-between items-start border-b pb-4 mb-6">
                ...
                <div class="text-right text-xs font-mono">
                   ...
                   <div><span class="text-slate-500 mr-2">Commit Hash:</span><span class="font-bold text-slate-800 border p-1 rounded bg-slate-50 text-[0.6rem] w-48 inline-block truncate align-bottom text-center">acb6e523c391de90f8ec02b87dec2774ee3f2c85</span></div>
                </div>
            </div>
